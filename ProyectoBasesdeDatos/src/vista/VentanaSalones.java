 ...
 * VentanaSalones
 */
public class VentanaSalones implements ActionListener { 
    ...
    public VentanaSalones(ArrayList<Salon> listadeSalonesA) {
        Lista = listadeSalonesA;
       ...
       /* String[][] data = {
        ...
        // Column Names
        String[] columnNames = { "IDSALON", "CAPACIDAD", "TIPO" };
