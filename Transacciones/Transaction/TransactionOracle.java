...
public class TransactionOracle {
	...
	public TransactionOracle() throws SQLException, IOException {
	...
	public static void main( String arg[] ) throws SQLException, IOException {
		...
		if( arg.length != 0 ) {
			...
			System.err.println( "Use: java TransactionOracle" );
			System.exit( 1 );
		}

		TransactionOracle transaction = new TransactionOracle();
